  ...
  const Navbar = () => {
    ...
    return (
      <nav className={`${ isScrolled || location.pathname !=="/" ? "bg-primaryColor" : "bg-transparent" } fixed top-0 w-full transition-all duration-300  z-50  py-4 text-white`}>
        ...
        <button
            ...
            >
              <img src={menuOpen ? cross_icon : menu_icon} alt="Menu" className="w-6 h-6" />
            </button>
        ...
        <div className="flex items-center space-x-7">
          { token ? <button onClick={()=> setToken(false)} className=" md:flex items-center gap-1 py-2 bg-buttonColor px-5 rounded-full font-dmSans">
            <span className="">Create</span> <span>Account </span>
              ...
              <img src={dropdown_icon} alt="" onClick={() => setDropDown(!dropDown)} />
